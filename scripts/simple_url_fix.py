...
REPLACEMENTS = {
    ...
    'realty.rbc': 'https://news.google.com/rss/search?q=%D0%B8%D0%BD%D0%B2%D0%B5%D1%81%D1%82%D0%B8%D1%86%D0%B8%D0%B8+%D0%BD%D0%B5%D0%B4%D0%B2%D0%B8%D0%B6%D0%B8%D0%BC%D0%BE%D1%81%D1%82%D1%8C&hl=ru&gl=RU&ceid=RU:ru',
}
...
lines = ['<b>RSS SOURCES FIXED</b>', '', 'Замены:']
lines += fixes if fixes else ['нет (URL уже были заменены ранее)']
lines += ['', 'StaticData: сброшена', 'Запущен: exec_id=' + str(exec_id), 'Жди 90 сек — пост в @grandvest_realty!']
tg('\n'.join(lines))
print('DONE')
